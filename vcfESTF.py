...
if len(sys.argv) == 6:    #takes in command line arguments example command below
    ...
    est_vcf_convert(sys.argv[1], sys.argv[2], sys.argv[4], sys.argv[5], sys.argv[3]) #example command you type for 3 bedfiles python3 vcfESTF.py bedFile1 bedFile2 bedFile3 vcfFile nameOfFile
    ...
    est_vcf_convert(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]) # example command you type for 2 bedfiles python3 vcfESTF.py bed1File bed2File vcfFile nameOfFile
